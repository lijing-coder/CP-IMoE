...
from model.Two_modality_pretraining_common import Base_Model
...
def run_train(model_name,mode,i):
    ...
    for epoch in range(epochs):
        ...
        if val_mean_acc > best_mean_acc:
            ...
            torch.save(net.common_synergistic_encoder.state_dict(), out_dir + '/checkpoint/{common_pretrain}_best_model.pth')
...
if __name__ == '__main__':
    ...
    mode = 'multimodal'
    model_name = 'common_SPC_Pretraining'
    shape = (224, 224)
    batch_size = 32
    num_workers = 8
    data_mode = 'Normal'
