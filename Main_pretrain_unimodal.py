...
from model.singal_modality_pretraining import Base_Model
...
#         vs_label = label[7].long().cuda()
        ...
        #print()
        logit_diagnosis_fusion = net(clinic_image)
...
def run_train(model_name,mode,i):
    ...
    for epoch in range(epochs):
        ...
        if val_mean_acc > best_mean_acc:
            ...
            torch.save(net.specificity_experts.state_dict(), out_dir + '/checkpoint/{modality_1_MLP_pretrain}_best_model.pth')
            torch.save(net.fundus_branch.state_dict(), out_dir + '/checkpoint/{modality_1_backbone_pretrain}_best_model.pth')
...
if __name__ == '__main__':
    ...
    mode = 'multimodal'
    model_name = 'modality_1_SPC_Pretraining_lr_5e-5'
    shape = (224, 224)
    batch_size = 32
    num_workers = 8
    data_mode = 'Normal'
